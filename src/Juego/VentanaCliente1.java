...
public class VentanaCliente1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaCliente1 frame = new VentanaCliente1();
	...
	public VentanaCliente1() {
		...
		btn_enviar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Cliente.barcosRival.setColumna(Integer.valueOf(VentanaCliente1.edt_columna.getText())-1);
				Cliente.barcosRival.setFila(Integer.valueOf(VentanaCliente1.edt_fila.getText())-1);
				Cliente.ok =  Cliente.comprobarMiTablero(Cliente.barcosRival);
			}
		});
